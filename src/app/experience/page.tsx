          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="p-4">
                <h3
                  ...
                  style={{ fontFamily: "var(--font-space)", color: "#8C1515" }}
                >
                  Coursework & Teaching
                </h3>
                <ul className="space-y-2">
                  <li className="text-xs text-foreground flex items-start gap-2">
                    ...
                    <span>
                      Conversational Virtual Assistants, Human Centered NLP, Reinforcement Learning,
                      Deep RL
                    </span>
                  </li>
                  <li className="text-xs text-foreground flex items-start gap-2">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="p-4">
                <h3
                  className="text-sm font-semibold mb-3"
                  style={{ fontFamily: "var(--font-space)", color: "#FF5F05" }}
                >
                  Coursework & Teaching
                </h3>
                <ul className="space-y-2">
                  <li className="text-xs text-foreground flex items-start gap-2">
                    ...
                    <span>
                      Senior Thesis: Generating Large Real World and Synthetic Graph Datasets for
                      GNN Applications
                    </span>
                  </li>
                  <li className="text-xs text-foreground flex items-start gap-2">
                    <span className="text-[#FF5F05] mt-0.5">•</span>
                    <span>
                      Coursework: NLP, ML, Deep Learning, Algorithms, Parallel Programming, Data
                      Structures, Database Systems, Computer Systems
                    </span>
                  </li>
                  <li className="text-xs text-foreground flex items-start gap-2">
                    <span className="text-[#FF5F05] mt-0.5">•</span>
                    <span>
                      Teaching: ECE 391 (Computer Systems), ECE 313 (Probability), ECE 210
                      (Signals), ECE 110 & Honors Lab
                    </span>
                  </li>
                  <li className="text-xs text-foreground flex items-start gap-2">
                    <span className="text-[#FF5F05] mt-0.5">•</span>
